package com.cloud.backstage2.controller;

import com.cloud.backstage2.service.TestUserService;
...
public class Login {
    ...
    public @ResponseBody String login(@RequestBody TestUser testUser){
        ...
        log.info("backstage2-post:"+testUser);
